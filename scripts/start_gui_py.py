...
使用方法:
    ...
    python3 scripts/start_gui_py.py --debug
    python3 scripts/start_gui_py.py --style fusion
"""
...
def main():
    ...
    while i < len(args):
        if args[i] == '--debug':
            ...
            print("使用方法:")
            print("  python3 scripts/start_gui_py.py")
            print("  python3 scripts/start_gui_py.py --debug")
            print("  python3 scripts/start_gui_py.py --style fusion")
            print("  python3 scripts/start_gui_py.py --headless")
            print("  python3 scripts/start_gui_py.py --framework PyQt6")
            sys.exit(0)
        else:
            i += 1
