...
使用方法:
    ...
    python3 scripts/start_health_monitor.py --interval 30
...
def main():
    ...
    while i < len(args):
        if args[i] == '--verbose' or args[i] == '-v':
            ...
            print("使用方法:")
            print("  python3 scripts/start_health_monitor.py")
            print("  python3 scripts/start_health_monitor.py --verbose")
            print("  python3 scripts/start_health_monitor.py --interval 30")
            sys.exit(0)
        else:
            i += 1
